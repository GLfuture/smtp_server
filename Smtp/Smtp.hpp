...
public:
    ...
    const std::string Rcpt_to(const std::string reciever)
    {
        std::string ret="RCPT TO:<"+reciever+">\r\n";
        return ret;
    }
    ...
    const std::string Msg(const std::string sender,const std::string reciever,const std::string type,const std::string charset,const std::string topic,const std::string body)
    {
